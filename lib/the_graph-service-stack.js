...
const { GraphNodeCluster } = require('./theGraphCluster-construct')
...
class GraphNodeServiceStack extends Stack {
  /**
   *
  ...
  constructor(scope, id, props) {
    ...
    const graphCluster = new GraphNodeCluster(this, `graph-cluster-${ENV}`, {
      clientUrl,
      chainId,
      graphInstanceType,
      dbInstanceType,
  ...
  //   const vpc = Vpc.fromLookup(this, 'Vpc', { vpcId: 'vpc-03624eae5aa2f6fbc' })
...
module.exports = { GraphNodeServiceStack }
