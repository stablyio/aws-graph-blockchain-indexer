...
const graphNodeClusterName = `GraphCluster-${process.env.ENV}`
const graphNodeClientRoleName = `graphNodeClientRole-${ENV}`
const graphNodeTaskDefName = `GraphNodeTaskDef-${ENV}`
...
class GraphNodeCluster extends Construct {
  ...
  constructor(scope, id, props) {
    ...
    const accessPoint = new AccessPoint(this, `graph-node-volume-access-point-${ENV}`, {
    ...
    const taskDefinition = new Ec2TaskDefinition(this, graphNodeTaskDefName, {
      volumes: [
        {
          name: efsVolumeName,
